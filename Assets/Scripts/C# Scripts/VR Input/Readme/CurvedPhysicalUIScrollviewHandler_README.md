# CurvedPhysicalUIScrollviewHandler

## 🇬🇧 English Documentation

### Overview

`CurvedPhysicalUIScrollviewHandler` is a script designed to handle VR interactions for Canvas UI elements—specifically curved interfaces—using a **"Physical Proxy"** approach for **Scrollbars** (commonly used in Scroll Views).
